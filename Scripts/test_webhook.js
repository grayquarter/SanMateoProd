...
// User code goes here
//
// aa.env.setValue("gqinsession_id", "ac756ab4de974aad9027e6352fe3ad1d")
...
aa.env.setValue("test1", "Please fill out the questions.");
aa.env.setValue("test2", 100);
aa.env.setValue("test3", 500);
