/*------------------------------------------------------------------------------------------------------/
| Program : ACA_LIC_GN2_RF_ONLOAD_TRN.js
...
try{
	// Show Page Based on Chapter Specific Questions
    useAppSpecificGroupName = true;
    if(getAppSpecific4ACA("GENERAL QUESTIONS.General TRN Question") == "CHECKED" && getAppSpecific4ACA("TRANSPORTATION AND WAREHOUSING.Q01") == "Excursion Boat Master License"){
